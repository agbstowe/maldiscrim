...
To use the deep learning features (FNN method) of this package, a dedicated Python virtual environment named `maldiscrim-env` must be configured. This background environment isolates mandatory Python dependencies—such as TensorFlow and Keras—preventing version conflicts with other Python projects on your computer.

**This setup only needs to be performed once**. You can automatically build, update, audit, or manually enforce the use of this environment using the following instructions:
